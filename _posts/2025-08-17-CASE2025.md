...
<div style="display:flex; flex-wrap:wrap; justify-content:center; gap:20px; text-align:center;">
  <a href="{{ '/members/1001_hongliang-li.html' | relative_url }}">
    <img src="{{ '/images/news/20250817Hongliang_CASE2025.png' | relative_url }}" alt="Hongliang" style="max-width:360px; width:100%; height:auto; border-radius:8px;">
  </a>
  <a href="{{ '/members/1003_jonghan-lim.html' | relative_url }}">
    <img src="{{ '/images/news/20250817Jonghan_CASE2025.png' | relative_url }}" alt="Jonghan" style="max-width:360px; width:100%; height:auto; border-radius:8px;">
  </a>
  <a href="{{ '/members/1004_yifei-li.html' | relative_url }}">
    <img src="{{ '/images/news/20250817Yifei_CASE2025.png' | relative_url }}" alt="Yifei" style="max-width:360px; width:100%; height:auto; border-radius:8px;">
  </a>
  <a href="{{ '/members/3001_gregory-beal.html' | relative_url }}">
    <img src="{{ '/images/news/20250817Gregory_CASE2025.png' | relative_url }}" alt="Gregory" style="max-width:360px; width:100%; height:auto; border-radius:8px;">
  </a>
</div>
