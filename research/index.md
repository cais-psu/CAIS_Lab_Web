...
{%- comment -%} helper: normalize author names into a single lowercased string {%- endcomment -%}
{%- assign ilya = "ilya" -%}
...
{%- for c in sorted -%}
  ...
  {%- for a in authors_arr -%}
    {%- assign nm = "" -%}
    {%- if a.name -%}{%- assign nm = a.name -%}{%- elsif a.literal -%}{%- assign nm = a.literal -%}{%- elsif a.family or a.given -%}{%- assign nm = a.given | default: "" | append: " " | append: a.family | strip -%}{%- else -%}{%- assign nm = a -%}{%- endif -%}
  ...
  {%- if venue contains "lecture notes" or venue contains "encyclopedia" or venue contains "handbook" -%}{%- assign is_book = true -%}{%- endif -%}
